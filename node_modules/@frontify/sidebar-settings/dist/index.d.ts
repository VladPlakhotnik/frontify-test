...
export declare type FontInputBlockChoice = {
    id?: number | string;
} & Choice;

export declare type FontInputChoicePresetValues = Partial<Record<'aligmentChoiceValues' | 'borderRadiusChoiceValues' | 'paddingSizeChoiceValues', FontInputBlockChoice[]>>;
...
export declare type FontValueBorderRadiusType = {
    topLeft: string;
    topRight: string;
    bottomRight: string;
    bottomLeft: string;
...
export declare type FontValuePaddingType = {
    top: string;
    right: string;
    bottom: string;
    left: string;
...
export declare type LinkBlock<AppBridge> = {
    /**
     * The setting type.
     */
    type: 'link';
...
export declare type SimpleSettingBlock<AppBridge> = AssetInputBlock<AppBridge> | ChecklistBlock<AppBridge> | ColorInputBlock<AppBridge> | DropdownBlock<AppBridge> | FontInputBlock<AppBridge> | InputBlock<AppBridge> | LegacyAssetInputBlock<AppBridge> | LinkChooserBlock<AppBridge> | LinkBlock<AppBridge> | MultiInputBlock<AppBridge> | NotificationBlock<AppBridge> | SectionHeadingBlock<AppBridge> | SegmentedControlsBlock<AppBridge> | SwitchBlock<AppBridge> | TemplateInputBlock<AppBridge> | LegacyTemplateInputBlock<AppBridge> | TextareaBlock<AppBridge>;
...
export declare const urlRule: Rule<string>;
